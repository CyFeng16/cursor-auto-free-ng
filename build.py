...
def build():
    ...
    try:
        ...
        result = subprocess.run(
            pyinstaller_command, check=True, capture_output=True,
        )
        loading.stop()

        # Decode stdout and stderr explicitly with error handling
        ...
        # Decode stderr from the exception object as well
        stderr_output = e.stderr.decode('utf-8', errors='ignore') if e.stderr else "No error details."
